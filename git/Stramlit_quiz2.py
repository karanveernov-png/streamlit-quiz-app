...
# ══════════════════════════════════════════════════════════════════════════════
# PAGE — QUIZ (FIXED DUPLICATION BUG USING st.empty)
# ══════════════════════════════════════════════════════════════════════════════
    ...
    # Create an empty placeholder container to completely clear out on every loop cycle
    ...
    # Precise 1-second refresh ticker for the UI live timer loop
    time.sleep(1)
    st.rerun()
